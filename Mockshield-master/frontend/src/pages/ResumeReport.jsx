...
const ResumeReport = () => {
  ...
  const rawTopic = state.topic || rootPayload.selectedDomain || rootPayload.domain || aiPayload.topic || "Professional Evaluation";
  ...
  const selectedField = rawTopic.replace(/_/g, " ").toUpperCase();
  ...
  const handleDownload = async () => {
    ...
    try {
        ...
        await logUserAction({
            ...
            details: `Candidate downloaded the Resume Audit Report for field: ${selectedField} (Score: ${processedData.score})`
        });
